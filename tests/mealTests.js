...
function getAllMeal() {
    ...
    let get_req = http.request(get_options, (res) => {
        ...
        res.on('end', () => {
            ...
            /*images.saveImage('./test_images/response/image.png',
                response.photos['1_2019-07-08'], (err) => {
...
function addMeal() {
    ...
    images.getImage('./test_images/photo.png', (err, image) => {
...
function editMeal() {
    images.getImage('./test_images/new_photo.png', (err, image) => {
